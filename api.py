...
try:
    ...
    stats_http.STATS_HEADERS = common_http.Header.NBA_STATS_HEADERS  # global constant
    stats_http.NBAStatsHTTP.headers = common_http.Header.NBA_STATS_HEADERS  # class default
